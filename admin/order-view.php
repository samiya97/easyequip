                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Orders View</h2>
                                    <div>
                                        <ul class="breadcrumb">
                      ...
                      <div class="widget has-shadow">
                                ...
                                include("connection.php");
                                 // $p = mysqli_query($var,"Select * from tbl_package");
                                    $p = mysqli_query($var,"SELECT o.id, u.u_id, o.customer_address, w.name, o.amount, o.date, o.status FROM tbl_order o, tbl_worker w, tbl_user u  where  w.id = o.worker_id  AND u.u_id=o.user_id ");
