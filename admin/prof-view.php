                                    ...
                                    <div class="widget-body">
                                       <div class="table-responsive"><table id="sorting-table" class="table mb-0 dataTable no-footer" role="grid" aria-describedby="sorting-table_info">
                                                <thead>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="sorting-table" rowspan="1" colspan="1" aria-label="Customer Name: activate to sort column ascending" style="width: 76px;">Professions</th>
                                                    ...
                                                    <td><span class="text-primary"><?php echo $abc['id'];  $idd=$abc['id'];  ?></span></td>
                                                        <td><?php echo $abc['services']; ?></td>
                                                         ...
                                                         <td class="td-actions">
                                                            ...
                                                            <a href='<?php echo "prof-delete.php?action=delete&id=$idd";?>'><i class="la la-close delete" onclick="return confirm('Are you sure you want to delete this?');"></i></a>
                                                        </td>
