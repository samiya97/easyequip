...
<html lang="en">
    <head>
        ...
        <title>EasyEquip - Worker Requests</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Worker Requests</h2>
                                    <div>
                                        <ul class="breadcrumb">
                      ...
                      <div class="widget has-shadow">
                                ...
                                include("connection.php");
                                 ...
                                 $p = mysqli_query($var,"Select s.id , s.address,c.phone_no,s.shop , s.shop_address,s.rating , c.name ,c.email, p.services from tbl_worker_details s , tbl_worker c  , tbl_profession p where status = 'pending' and s.worker_id = c.id and s.prof_id = p.id ");
...
$ab = "Update tbl_worker_details set status='approve' WHERE id ='$idd' ";
     
 mysqli_query($var,$ab);

 echo"<script>alert('approved request succesfully');</script>";
