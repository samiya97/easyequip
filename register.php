...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('img/rg-bg-01.jpg');"></div>

			<div class="wrap-login100 p-r-50 p-t-72 p-b-20">
				<a href="index.php">
				...
				<form class="login100-form validate-form" name="form" action="backend/back_register.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Gender is required">
						...
						<select name="gender" class="input100" style="width: 90%">
					...
					<div class="wrap-input100 validate-input" data-validate = "Profession is required">
						...
						<select name="profession" class="input100" style="width: 90%">
