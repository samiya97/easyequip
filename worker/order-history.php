...
<html lang="en">
    <head>
        ...
        <title>Easy Equip - Order History</title>
                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Orders History</h2>
                                    <div>
                                        <ul class="breadcrumb">
                      ...
                      <div class="widget has-shadow">
                               ...
                               $db = mysqli_select_db($con,"easyequip");
                                 // $p = mysqli_query($var,"Select * from tbl_package");
                                    ...
                                    $sql = "SELECT o.id, u.u_id, o.customer_address, w.name, o.amount, o.date, o.status FROM tbl_order o, tbl_worker w, tbl_user u  where  w.id = o.worker_id AND w.email='".$_SESSION['email']."'  AND u.u_id=o.user_id and o.status= 'approve'"; 
                                               ...
                                               <tr role="row" class="even">
                                                        ...
                                                        <td><?php echo $abc['date']; ?></td>
                                                         ...
                                                         <td class="td-actions">
                                                            ...
                                                            <a href='<?php echo "order-history-delete.php?action=delete&id=$idd";?>'><i class="la la-close delete" onclick="return confirm('Are you sure you want to delete this?');"></i></a>
